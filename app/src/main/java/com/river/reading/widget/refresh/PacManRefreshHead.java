package com.river.reading.widget.refresh;
...
public class PacManRefreshHead extends RefreshHead {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mPaint.setColor(typedArray.getColor(R.styleable.PacManRefreshHead_pacIconColor, ContextCompat
                .getColor(context, R.color.material_black55)));
            typedArray.recycle();
        }
