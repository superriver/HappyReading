 ...
 */
@ActivityFragmentInject(contentViewId = R.layout.image_girl_detail) public class GirlActivity
  ...
  protected BaseFragment getFirstFragment() {
    mGirlFragment = GirlFragment.getInstance(getIntent().getParcelableArrayListExtra("girl"),
